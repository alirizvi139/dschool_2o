...
class sm_schoolsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        for($i=2; $i<=5; $i++){
            ...
            $s->primary_color = '#1d677a';
            $s->primary_color2 = '#1d677a';
            ...
            $s->barchart1 = '#1d677a';
            $s->barchart2 = '#1c6679';
            $s->barcharttextcolor = '#1c6679';
            $s->barcharttextfamily = '"Cerebri Sans", Helvetica, Arial, sans-serif';
            $s->areachartlinecolor1 = '#1d677a';
            $s->areachartlinecolor2 = '#1c6679';
