...
<head>
    ...
    <style>
        ...
        .table_title h3{
            ...
            border-bottom: 2px solid #1d677a;
        }
...
<body onLoad="loadHandler();">
    <div class="invoice_wrapper">
        ...
        <table style="width:100%" class="border-0">
                ...
                <tr> 
                    <td class="border-0">
                    <p class="result-date" style="text-align:left; float:left; display:inline-block; margin-top:50px; padding-left: 0; color: #1d677a;">
                    ...
                    <div class="text-right d-flex flex-column justify-content-end">
                        ...
                        @endif
                            ...
                            <p style="text-align:right; float:right; display:inline-block; margin-top:5px; color: #1d677a;">
                            ({{@$exam_content->title}})
                            </p> 
                        </div>
                    </td>
