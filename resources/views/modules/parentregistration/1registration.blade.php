...
.datepicker table tr td.day:hover {
    border-radius: 20px;
    background: -webkit-linear-gradient(90deg, #1d677a 0%, #2d899f 100%);
    background: -moz-linear-gradient(90deg, #1d677a 0%, #2d899f 100%);
    background: -o-linear-gradient(90deg, #1d677a 0%, #2d899f 100%);
    background: linear-gradient(90deg, #1d677a 0%, #2d899f 100%);
}
...
.cupon_code_iner a {
  border-radius: 5px;
  background-image: -moz-linear-gradient(0deg, #1d677a 0%, #a235ec 70%, #2d899f 100%);
  background-image: -webkit-linear-gradient(0deg, #1d677a 0%, #a235ec 70%, #2d899f 100%);
  background-image: -ms-linear-gradient(0deg, #1d677a 0%, #a235ec 70%, #2d899f 100%);
