 ...
 <?php if(isset($students)): ?>
    <section class="admin-visitor-area">
        <div class="container-fluid p-0">
            ...
            <style>
            .all_check{
                background: linear-gradient(90deg, #1d677a 0%, #c738d8 51%, #1d677a 100%);
                color: #ffffff;
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Celestialcode\infixEduV6.3.1\resources\views/backEnd/academics/assign_optional_subject.blade.php ENDPATH**/ ?>