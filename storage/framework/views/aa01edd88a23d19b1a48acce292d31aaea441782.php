        ...
        <div class="container-fluid">
            <div class="row justify-content-between">
                ...
                <div class="bc-pages">
                    ...
                    <a href="#"><?php echo app('translator')->get('lang.pay_fees'); ?></a>
                </div>
            </div>
        </div>
    </section>
                            ...
                            <tr>
                                ...
                                <td>
                                     ...
                                     <button class="primary-btn small bg-primary text-white border-0">
                                                <?php echo app('translator')->get('lang.completed'); ?>
                                            </button>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <?php if($already_add == "" && $balance_amount !=0): ?>
                                                    <?php if(@$data['bank_info']->active_status == 1 || @$data['cheque_info']->active_status == 1): ?>
                                                        ...
                                                        <a class="dropdown-item modalLink" data-modal-size="modal-lg"
                                                           ...
                                                           href="<?php echo e(route('fees-generate-modal-child', [$fees_assigned->fees_amount, $fees_assigned->student_id, $fees_assigned->feesGroupMaster->fees_type_id,$fees_assigned->id])); ?>"> <?php echo app('translator')->get('lang.add'); ?> <?php echo app('translator')->get('lang.bank'); ?> <?php echo app('translator')->get('lang.payment'); ?> </a>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <?php if($balance_amount !=0): ?>
                                                            <a class="dropdown-item modalLink" data-modal-size="modal-lg" title="<?php echo e($fees_assigned->feesGroupMaster->feesGroups->name.': '. $fees_assigned->feesGroupMaster->feesTypes->name); ?>"  href="<?php echo e(route('fees-generate-modal-child', [$fees_assigned->fees_amount, $fees_assigned->student_id, $fees_assigned->feesGroupMaster->fees_type_id,$fees_assigned->id])); ?>" > <?php echo app('translator')->get('lang.add'); ?> <?php echo app('translator')->get('lang.bank'); ?> <?php echo app('translator')->get('lang.payment'); ?></a>
                                                ...
                                                <?php if(!empty($is_paystack) && $balance_amount !=0): ?>
                                                    <form method="POST" action="<?php echo e(route('pay-with-paystack')); ?>"
                                                          accept-charset="UTF-8" class="form-horizontal" role="form">
                                                            <input type="hidden" name="assign_id" value="<?php echo e($fees_assigned->id); ?>">
                                                    ...
                                                    <input type="hidden" name="email"
                                                        ...
                                                        <input type="hidden" name="key"
                                                               value="<?php echo e(config('paystack.secretKey')); ?>"> 
                                                ...
                                                <?php if(!empty($is_paypal) && $balance_amount !=0): ?>
                                                    <form method="POST" action="<?php echo e(route('payByPaypal')); ?>"
                                                          accept-charset="UTF-8" class="form-horizontal" role="form">
                                                                <?php echo csrf_field(); ?>
                                                            <input type="hidden" name="assign_id" value="<?php echo e($fees_assigned->id); ?>">
                                                            <input type="hidden" name="url" id="url" value="<?php echo e(URL::to('/')); ?>">
                                                            <input type="hidden" name="real_amount" id="real_amount" value="<?php echo e($fees_assigned->fees_amount); ?>">
                                                            <input type="hidden" name="student_id" value="<?php echo e($student->id); ?>">
                                            ...
                                            <?php if(!empty($is_stripe) && $balance_amount !=0): ?>
                                                    ...
                                                    <a class="dropdown-item modalLink" data-modal-size="modal-lg"
                                                       ...
                                                       ?>
                                                       href="<?php echo e(route('fees-payment-stripe',[$fees_assigned->feesGroupMaster->fees_type_id, $student->id,  $fees_assigned->fees_amount,$fees_assigned->id])); ?>">
...
<?php endif; ?>
                                                ...
                                                <?php if(moduleStatusCheck('RazorPay')== TRUE ): ?>
                                                    <?php if(moduleStatusCheck('RazorPay') == TRUE && !empty($is_RazorPay)): ?>
                                                        <form id="rzp-footer-form_<?php echo e($count); ?>"
                                                              action="<?php echo route('razorpay/dopayment'); ?>" method="POST"
                                                              style="width: 100%; text-align: center">
                                                            <?php echo csrf_field(); ?>
                                                            <input type="hidden" name="assign_id" value="<?php echo e($fees_assigned->id); ?>">
                                                            <input type="hidden" name="amount" id="amount"
                            ...
                            <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td class="text-right"><img src="<?php echo e(asset('public/backEnd/img/table-arrow.png')); ?>">
                                    </td>
                                    <td>
                                        <?php
                        ...
                        <?php $__currentLoopData = $fees_discounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fees_discount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php if(in_array($fees_discount->id, $applied_discount)): ?>
                                        ...
                                        <?php if($createdBy != ""): ?>
                                            ...
                                            <?php if(!empty( $created_by )): ?>
                                                <a href="#" data-toggle="tooltip" data-placement="right"
                                                   title="<?php echo e('Collected By: '.$created_by->full_name); ?>"><?php echo app('translator')->get('lang.discount'); ?> <?php echo app('translator')->get('lang.of'); ?> <?php echo e(generalSetting()->currency_symbol); ?><?php echo e(number_format($fees_discount->feesDiscount->amount, 2, '.', '')); ?> <?php echo app('translator')->get('lang.applied'); ?>
                                    ...
                                    <?php else: ?>
                                        <?php echo app('translator')->get('lang.discount_of'); ?> <?php echo e(generalSetting()->currency_symbol); ?><?php echo e($fees_discount->feesDiscount !=""?number_format($fees_discount->feesDiscount->amount, 2, '.', '') :""); ?> <?php echo app('translator')->get('lang.assigned'); ?>
                                    <?php endif; ?>
                                </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Celestialcode\infixEduV6.3.1\resources\views/backEnd/parentPanel/childrenFees.blade.php ENDPATH**/ ?>