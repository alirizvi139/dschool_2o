    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php else: ?>
                    <h3 class="mb-3"><?php echo app('translator')->get('lang.welcome'); ?> - <?php echo e(@Auth::user()->school->school_name); ?> | <?php echo e(@Auth::user()->roles->name); ?></h3>
                <?php endif; ?>
                </div>
            </div>
        </div>
            ...
            <a href="#" class="d-block">
                <div class="white-box single-summery dashboard_box1">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h3 class="font-weight-bold"><?php echo app('translator')->get('lang.student'); ?></h3>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <a href="#" class="d-block">
                <div class="white-box single-summery dashboard_box2">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h3 class="font-weight-bold"><?php echo app('translator')->get('lang.teachers'); ?></h3>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <a href="#" class="d-block">
                <div class="white-box single-summery dashboard_box3">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h3 class="font-weight-bold"><?php echo app('translator')->get('lang.parents'); ?></h3>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <a href="#" class="d-block">
                <div class="white-box single-summery dashboard_box4">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h3 class="font-weight-bold"><?php echo app('translator')->get('lang.staffs'); ?></h3>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Celestialcode\infixEduV6.3.1\resources\views/backEnd/dashboard.blade.php ENDPATH**/ ?>