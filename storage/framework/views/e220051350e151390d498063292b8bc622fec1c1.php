                            ...
                            <div class="row p-0">
                                <div class="col-lg-12">
                                    ...
                                    <div class="row mb-40 mt-40">
                                        <div class="col-lg-6">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input class="primary-input form-control<?php echo e($errors->has('signature_p') ? ' is-invalid' : ''); ?>" type="text" name="footer_1" value="<?php echo e($invoiceSettings->footer_1); ?>">
                                    ...
                                    <div class="row mb-40 mt-40">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input class="primary-input form-control<?php echo e($errors->has('footer_2') ? ' is-invalid' : ''); ?>" type="text" name="footer_2" value="<?php echo e($invoiceSettings->footer_2); ?>">
                                                <label><?php echo app('translator')->get('lang.signature'); ?><span>*</span></label>
                                                <span class="focus-border"></span>
                                    ...
                                    <div class="row mb-40 mt-40">
                                        <div class="col-lg-6">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input class="primary-input form-control<?php echo e($errors->has('footer_3') ? ' is-invalid' : ''); ?>" type="text"  name="footer_3" value="<?php echo e($invoiceSettings->footer_3); ?>">
                                                <label><?php echo app('translator')->get('lang.signature'); ?><span>*</span></label>
                                                <span class="focus-border"></span>
                                    ...
                                    <div class="row mb-40 mt-40">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input class="primary-input form-control<?php echo e($errors->has('copy_s') ? ' is-invalid' : ''); ?>" type="text" name="copy_s" id="copy_s"  value="<?php echo e($invoiceSettings->copy_s); ?>">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input class="primary-input form-control<?php echo e($errors->has('copy_s') ? ' is-invalid' : ''); ?>" type="text" name="copy_o" id="copy_o" value="<?php echo e($invoiceSettings->copy_o); ?>">
                                                <label><?php echo app('translator')->get('lang.copy'); ?> <?php echo app('translator')->get('lang.for'); ?><span>*</span></label>
                                                <span class="focus-border"></span>
                                                <?php if($errors->has('copy_s')): ?>
                                                <span class="invalid-feedback invalid-select" role="alert">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input class="primary-input form-control<?php echo e($errors->has('copy_c') ? ' is-invalid' : ''); ?>" type="text" name="copy_c"  id="copy_c" value="<?php echo e($invoiceSettings->copy_c); ?>">
                                                <label><?php echo app('translator')->get('lang.copy'); ?> <?php echo app('translator')->get('lang.for'); ?><span>*</span></label>
                                                <span class="focus-border"></span>
                                                <?php if($errors->has('copy_s')): ?>
                                                <span class="invalid-feedback invalid-select" role="alert">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Celestialcode\infixEduV6.3.1\Modules/BulkPrint\Resources/views/feesCollection/invoice_settings.blade.php ENDPATH**/ ?>