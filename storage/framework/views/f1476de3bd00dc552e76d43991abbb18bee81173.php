...
<?php $__env->startSection('mainContent'); ?>
    <style type="text/css">
        ...
        input:checked + .slider {
            background: linear-gradient(90deg, #1d677a 0%, #2d899f 51%, #1d677a 100%);
        }

        input:focus + .slider {
            box-shadow: 0 0 1px linear-gradient(90deg, #1d677a 0%, #2d899f 51%, #1d677a 100%);
        }
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Celestialcode\infixEduV6.3.1\resources\views/backEnd/systemSettings/buttonDisableEnable.blade.php ENDPATH**/ ?>